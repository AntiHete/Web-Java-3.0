...
public @interface ValidSpaceAddress {
    ...
    String SPACE_ADDRESS_SHOULD_BE_VALID = "\"Invalid Space Address: The provided address does not conform to the required format. Please ensure that it includes valid coordinates, sector, and planet information. WebJava: 'Sector 5, Planet Zeta, Quadrant 12'.\"\n";
